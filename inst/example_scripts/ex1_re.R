...
# (1) Read in existing rwout.rep files
?read_re_dat
re_dat <- read_re_dat(filename = 'inst/example_data/aisr_rwout.rep',
...
re_dat <- read_re_dat(filename = 'inst/example_data/bsaisst_rwout.rep',
...
re_dat <- read_re_dat(filename = 'inst/example_data/goasr_rwout.rep',
...
re_dat <- read_re_dat(filename = 'inst/example_data/goasst_rwout.rep',
